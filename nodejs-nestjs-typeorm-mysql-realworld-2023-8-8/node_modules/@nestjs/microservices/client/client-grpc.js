...
class ClientGrpcProxy extends client_proxy_1.ClientProxy {
    ...
    createClientByServiceName(name) {
        ...
        const options = shared_utils_1.isObject(this.options)
            ? Object.assign(Object.assign(Object.assign(Object.assign({}, this.options), maxMessageLengthOptions), keepaliveOptions), { loader: '' }) : Object.assign({}, maxMessageLengthOptions);
