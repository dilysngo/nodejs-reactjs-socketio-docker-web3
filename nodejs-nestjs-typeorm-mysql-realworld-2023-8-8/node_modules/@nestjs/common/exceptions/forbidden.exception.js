...
class ForbiddenException extends http_exception_1.HttpException {
     ...
     */
    constructor(objectOrError, message = 'Forbidden') {
        super(http_exception_1.HttpException.createBody(objectOrError, message, http_status_enum_1.HttpStatus.FORBIDDEN), http_status_enum_1.HttpStatus.FORBIDDEN);
    }
}
