...
class ConflictException extends http_exception_1.HttpException {
     ...
     */
    constructor(objectOrError, message = 'Conflict') {
        super(http_exception_1.HttpException.createBody(objectOrError, message, http_status_enum_1.HttpStatus.CONFLICT), http_status_enum_1.HttpStatus.CONFLICT);
    }
}
