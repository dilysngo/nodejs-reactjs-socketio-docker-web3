...
class GatewayTimeoutException extends http_exception_1.HttpException {
     ...
     */
    constructor(objectOrError, message = 'Gateway Timeout') {
        super(http_exception_1.HttpException.createBody(objectOrError, message, http_status_enum_1.HttpStatus.GATEWAY_TIMEOUT), http_status_enum_1.HttpStatus.GATEWAY_TIMEOUT);
    }
}
