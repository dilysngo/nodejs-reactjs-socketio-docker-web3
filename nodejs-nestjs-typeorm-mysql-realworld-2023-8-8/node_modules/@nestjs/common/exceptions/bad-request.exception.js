...
class BadRequestException extends http_exception_1.HttpException {
     ...
     */
    constructor(objectOrError, message = 'Bad Request') {
        super(http_exception_1.HttpException.createBody(objectOrError, message, http_status_enum_1.HttpStatus.BAD_REQUEST), http_status_enum_1.HttpStatus.BAD_REQUEST);
    }
}
