...
class UnprocessableEntityException extends http_exception_1.HttpException {
     ...
     */
    constructor(objectOrError, message = 'Unprocessable Entity') {
        super(http_exception_1.HttpException.createBody(objectOrError, message, http_status_enum_1.HttpStatus.UNPROCESSABLE_ENTITY), http_status_enum_1.HttpStatus.UNPROCESSABLE_ENTITY);
    }
}
