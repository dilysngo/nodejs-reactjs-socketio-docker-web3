...
class DependenciesScanner {
    ...
    addScopedEnhancersMetadata() {
        const scopedGlobalProviders = this.applicationProvidersApplyMap.filter(wrapper => this.isRequestOrTransient(wrapper.scope));
        scopedGlobalProviders.forEach(({ moduleKey, providerKey }) => {
            ...
            controllers.forEach(controller => controller.addEnhancerMetadata(instanceWrapper));
        });
    }
