...
import { BaseListResponse } from '../shared/base.interface';
...
export class ArticleService {
  ...
  async findAll(query): Promise<BaseListResponse<ArticleEntity[]>> {
